...
Game.Map.prototype.isEmptyFloor = function(x, y, z) {
    ...
    return this.getTile(x, y, z).describe() == 'floorTile' && !this.getEntityAt(x, y, z);
};
...
Game.Map.prototype.getTile = function(x, y, z) {
    ...
    if (x < 0 || x >= this._width || y < 0 || y >= this._height || z < 0 || z >= this._depth) {
        return Game.TileRepository.create('nullTile');
    } else {
        return this._tiles[z][x][y] || Game.TileRepository.create('nullTile');
    }
};
...
Game.Map.prototype.setExplored = function(x, y, z, state) {
    ...
    if (this.getTile(x, y, z).describe() !== 'nullTile') {
...
Game.Map.prototype.dig = function(x, y, z) {
	if(this.getTile(x, y, z).isDiggable()) {
		this._tiles[z][x][y].describe() = 'floorTile';
	}
};