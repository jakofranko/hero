...
Game.Commands.swapCommand = function(diffX, diffY, diffZ) {
    return function(entity) {
        var newX   = entity.getX() + diffX;
        var newY   = entity.getY() + diffY;
        var newZ   = entity.getZ() + diffZ;
        var target = entity.getMap().getEntityAt(newX, newY, newZ);
        if(target)
